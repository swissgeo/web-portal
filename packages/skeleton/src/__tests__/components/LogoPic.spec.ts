...
describe('LogoPic behavior', () => {
    ...
    `('$description', ({ _, isDesktop, condensed }) => {
        ...
        const condensedLogoPic = wrapper.find(`[data-testid="sidebar-logo-pic-condensed"]`)
        const extendedLogoPic = wrapper.find(`[data-testid="sidebar-logo-pic-extended"]`)
        const separator = wrapper.find(`[data-testid="sidebar-logo-pic-separator"]`)
