...
<template>
  ...
  <div class="flex items-center justify-center p-2">
    <ULocaleSelect class="w-12 h-12 flex items-center justify-center cursor-pointer" :model-value="locale"
      :locales="locales" :highlight="true" :highlight-on-hover="true" :arrow="false" size="sm" variant="ghost"
      :leading="true" :trailing="false" :portal="'body'" :content="{ side: 'top', sideOffset: 8 }"
      aria-label="Language switcher" :ui="{
        ...
        content: 'lang-switcher-popover z-[9999] pointer-events-auto bg-white opacity-100 shadow-2xl rounded-md mb-2',
      ...
      }" :trailing-icon="undefined" @update:model-value="handleLocaleChange" />
  </div>
</template>