...
|humanId|A human readable ID|This is usally used in log messages and similar, in order to be able to track the layer. This is field *is not* unique, the same layer could be added to the map twice|
