...
export const useMenuStore = defineStore("menuStore", () => {
  ...
  /**
   * Search for an entry of the document id in the menues
   * and return the submenu if it has any
   *
  ...
  function findSubMenuOfDocument(documentId: string) {
    ...
    const isLang = (index: string): index is Lang =>
      ["de", "fr"].includes(index);
