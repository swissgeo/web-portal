...
import { DEFAULT_LOCALE, pickLocaleFromAcceptLanguage, VALID_LOCALES } from '@swissgeo/shared'
...
export function resolveTargetLocale(acceptLanguage: string | undefined): Lang {
    return pickLocaleFromAcceptLanguage(acceptLanguage, VALID_LOCALES) ?? DEFAULT_LOCALE
}
