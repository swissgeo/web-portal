...
<template>
  <div
    v-show="isVisible"
    class="light overflow-hidden rounded-md bg-default text-default shadow-lg ring-1 ring-default"
    @click.stop
  >
    <div
    ...
    <div v-show="!isCollapsed">
      <UTabs :items="tabs" variant="link" size="sm" :unmount-on-hide="false">
        <template #position>
