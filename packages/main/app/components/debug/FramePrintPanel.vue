...
function handleSendPrintRequest() {
    // For debugging purposes, we log the print request body that would be sent to the print service
    console.log('Print Request Body:', printRequestBody.value)
}
</script>
...
<template>
    <div class="z-10 h-fit min-h-[100px] w-fit min-w-[100px] bg-white p-[10px]">
        ...
        <div class="flex flex-col gap-4">
            ...
            >
                <USwitch
                    id="enable-zoom-step-checkbox"
                    v-model="isZoomStepEnabled"
                />
            </UFormField>
            ...
            >
                <USwitch
                    id="lock-center-checkbox"
                    v-model="isCenterLocked"
                />
            </UFormField>
            ...
            >
                <USwitch
                    id="lock-zoom-checkbox"
                    v-model="isZoomLocked"
                />
            </UFormField>
