...
describe('useUrlParam base64 state extraction', () => {
    beforeEach(() => {
        useRouteMock.query = {
            ...
            state: 'ewogICJ2ZXJzaW9uIjogIjEuMCIsCiAgInN0YXRlIjogewogICAgIm1hcCI6IHsKICAgICAgImNlbnRlciI6IFsKICAgICAgICAyNjYwMDAwLAogICAgICAgIDExOTAwMDAKICAgICAgXQogICB9CiAgfQp9',
        }
