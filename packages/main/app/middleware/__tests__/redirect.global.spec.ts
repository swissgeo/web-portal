...
import { isLocaleRoot, isLocalized, redirector, resolvePreferredLocale } from '../redirect.global'
...
describe('redirect plugin', () => {
    ...
    it.each([
        ...
        expect(navigateToMock).toHaveBeenCalledExactlyOnceWith(toObj, { redirectCode: 302 })
    })
