            ...
            >
                ...
                >
                    ...
                    <div class="text-justify">
                        <p class="mb-[0.25em]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc nisl tellus, placerat eget luctus pulvinar, vehicula nec velit. Integer eu pharetra libero. Phasellus eu pretium orci. Nullam quis lacus mauris. Morbi tellus dui, faucibus vel mi a, faucibus luctus ex. Aenean vel ligula fermentum, dictum nunc et, sollicitudin eros. Aliquam erat volutpat. Phasellus pharetra lacus sit amet arcu elementum vulputate. Etiam lacus nunc, varius vel laoreet eu, commodo commodo nisi. Ut efficitur aliquam volutpat. Fusce euismod consectetur fringilla. Nulla ac ultricies ipsum.</p>
                        <p class="mb-[0.25em]">Nam vel auctor nunc. Maecenas malesuada velit non massa condimentum tristique feugiat et ex. Proin commodo nibh mi, a auctor justo tincidunt ac. Praesent et aliquam turpis. In elementum lorem vel felis venenatis, quis ullamcorper velit accumsan. Curabitur sit amet magna non sapien bibendum laoreet.</p>
                        <p>© Lorem Ipsum</p>
                    </div>
                </div>
            </div>
