...
import { /*parseWmtsCapabilities,*/ useWmtsCapabilities } from '../useWmtsCapabilities'
...
const wmsPath = resolve(__dirname, 'fixtures/capabilities_wmts.geo.admin.ch.xml')
const capabilitiesXML = fs.readFileSync(wmsPath, 'utf-8')

describe('useWmtsCapabilities fetching and parsing WMTS capabilities', () => {
    const handlers = [
        http.get('https://wmts.geo.admin.ch/EPSG/2056/1.0.0/WMTSCapabilities.xml', () => {
