...
// Base URL of the app state sharing service, can be overridden by setting the NUXT_PUBLIC_SHARE_SERVICE_URL environment variable
export const APP_STATE_SERVICE_BASE_URL: string =
  process.env.NUXT_PUBLIC_SHARE_SERVICE_URL ??
