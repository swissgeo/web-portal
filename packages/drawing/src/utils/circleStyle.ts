...
export const CIRCLE_EDITING_STYLE: StyleFunction = (_feature: FeatureLike) => {
  return [
    ...
    new Style({
      ...
      geometry: function (feature) {
        const circleCoordinates = (feature.getGeometry() as Circle).getCenter();
...
/**
 * The style function for circles in non-editing mode.
 ...
 */
export const CIRCLE_IDLE_STYLE: StyleFunction = (feature: FeatureLike) => {
  const props = feature.getProperties();
