...
export const LINESTRING_EDITING_STYLE: StyleFunction = (
...
export const LINESTRING_SELECTED_STYLE = (feature: FeatureLike) => {
...
/**
 * The style function for line strings in non-editing mode.
 ...
 */
export const LINESTRING_IDLE_STYLE: StyleFunction = (feature: FeatureLike) => {
  const props = feature.getProperties();
